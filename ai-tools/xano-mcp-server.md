...
{% hint style="success" %}
Need a primer on MCP? Read this first: [#intro](mcp-builder/#intro "mention")
{% endhint %}
...
The Xano MCP Server is powered by our [metadata-api](../xano-features/metadata-api/ "mention"), and we expect to eventually allow for all of the methods present there to be used as tools within the Xano MCP Server.
...
The Xano MCP Server, powered by our [metadata-api](../xano-features/metadata-api/ "mention"), enables you to interact with your Xano instance and workspaces without leaving your favorite MCP client.

## Connecting to the Xano MCP Server

{% stepper %}
{% step %}
### From the Instance selection screen, click the :gear: icon next to your instance, and choose <mark style="background-color:blue;">Metadata API & MCP Server</mark>&#x20;
...
Access Tokens are used for authentication when connecting to the Xano MCP server. For more information on generating access tokens, see this reference: [#generate-an-access-token](../xano-features/metadata-api/#generate-an-access-token "mention")
{% endstep %}
...
For more information on connecting your clients to an MCP server, refer to [connecting-clients.md](mcp-builder/connecting-clients.md "mention") or to your client's documentation for the most up to date information.
...
* **workspaceRealtimeDetails** - Retrieves [Broken link](broken-reference "mention") information for the specified workspace.
...
* **getApiGroupSwagger** - Returns the JSON version of the [swagger-openapi-documentation.md](../the-function-stack/building-with-visual-development/apis/swagger-openapi-documentation.md "mention") for a specific API group
* **getApiSwagger** - Returns the JSON version of the [swagger-openapi-documentation.md](../the-function-stack/building-with-visual-development/apis/swagger-openapi-documentation.md "mention") for a specific API
