...
This is the XanoScript command for [Get Record](../../the-function-stack/functions/database-requests/get-record.md). From here, things get a little more specific depending on the function you are using. For example, `db.get` is immediately followed by the name of the table we're querying.
